...
##### Distribution of R^2
The bootstrap distribution of r^2 is approximately bell-shaped and symmertric, centered around 0.94. This indicates that across the repeated resampling of the Central Park weather data, the fitted linear regression model with predictors tmin and prcp are able to explain about 94% of the variability in tmax.
